  ...
  return (
    <nav class="bg-white  fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div class="max-w-screen-xl mx-auto gap-2 flex flex-wrap items-center   p-4">
        ...
        <div
          class="items-center ms-auto  px-2 justify-end hidden w-full md:flex md:w-auto md:order-1"
          id="navbar-sticky"
        >
          {/* show in large screen */}
          <ul class="flex flex-col items-start   p-4 md:p-0 mt-4 font-medium border  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0    ">
